    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItem_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItem_Products_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuItem_Products_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order_MenuItems", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_MenuItems_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItem_Products_MenuItemId",
                table: "MenuItem_Products",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuItem_Products_ProductId",
                table: "MenuItem_Products",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_MenuItems_OrderId",
                table: "Order_MenuItems",
                column: "OrderId");
